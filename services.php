    ...
    <div class="container">
        ...
        <div class="services">
            ...
            <img src="images/housekeeping.png" class="services-images">
                ...
                <a href="housekeeping.html" class="btn">Explore</a>
            </div>
            ...
            <img src="images/babysitting.png" class="services-images">
                ...
                <a href="sample2/sample2.html" class="btn">Explore</a>
            </div>
            ...
            <img src="images/eldercare.png" class="services-images">
                ...
                <a href="sample3/sample3.html" class="btn">Explore</a>
            </div>
        </div>
  ...
  (function(d, t) {
      ...
      v.onload = function() {
        window.voiceflow.chat.load({
          verify: { projectID: '67fb815a62f6849a97c7c341' },
